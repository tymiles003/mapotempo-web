...
class VehicleUsagesControllerTest < ActionController::TestCase
  ...
  test 'should update vehicle_usage' do
    ...
    assert_equal @vehicle_usage.vehicle.reload.router_options, { 'time' => 'true', 'weight' => '10', 'motorway' => 'true', 'trailers' => '2' }
  end
