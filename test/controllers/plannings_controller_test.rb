...
class PlanningsControllerTest < ActionController::TestCase
  ...
  test 'should show planning as csv with order array' do
    ...
    assert_response :success
    assert_equal 'r1,planning1,route_zero,,,visite,,,,,,"","","",,,a,unaffected_one,MyString,MyString,MyString,MyString,,1.5,1.5,MyString,MyString,tag1,a,00:01:00,,10:00,11:00,,,tag1', response.body.split("\n")[1]
    assert_equal 'r1,planning1,route_one,001,1,visite,1,,00:00,1.1,,"","","",,,b,destination_one,Rue des Lilas,MyString,33200,Bordeau,,49.1857,-0.3735,MyString,MyString,"",b,00:05:33,P1/P2,10:00,11:00,,,tag1', response.body.split("\n").select{ |l| l.include?('001') }[1]
  end
