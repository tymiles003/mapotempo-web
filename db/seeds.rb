...
truck = RouterWrapper.create!(
    ...
    url_time: 'http://localhost:9090',
    options: {time: true, distance: false, avoid_zones: true, isochrone: true, isodistance: true, motorway: true, toll: true, trailers: true, weight: true, weight_per_axle: true, height: true, width: true, length: true})
