...
mapnik_bw = Layer.create!(source: "osm", name: "Mapnik B&W", url: "http://{s}.toolserver.org/tiles/bw-mapnik/{z}/{x}/{y}.png", urlssl: "https://{s}.toolserver.org/tiles/bw-mapnik/{z}/{x}/{y}.png", attribution: "Tiles by Wikimedia")
...
profile_osm = Profile.create!(name: "OSM", layers: [mapbox, mapnik, mapnik_fr, mapnik_bw, mapquest, stamen_bw], routers: [osrm])
profile_here = Profile.create!(name: "Here", layers: [here_layer], routers: [here_router])
profile_all = Profile.create!(name: "All", layers: [mapbox, mapnik, mapnik_fr, mapnik_bw, mapquest, stamen_bw, here_layer], routers: [osrm, here_router])
customer = Customer.create!(name: "Toto", router: osrm, profile: profile_osm, test: true)
admin = User.create!(email: "admin@example.com", password: "123456789", admin: true, layer: mapbox)
