...
Visit.create!(ref: 'v1', quantity1_1: 1, destination: Destination.create!(name: "l1", street: "Place Picard", postalcode: "33000", city: "Bordeaux", lat: 44.84512, lng: -0.578, customer: customer))
Visit.create!(ref: 'v2', quantity1_1: 1, destination: Destination.create!(name: "l2", street: "Rue Esprit des Lois", postalcode: "33000", city: "Bordeaux", lat: 44.83395, lng: -0.56545, customer: customer))
Visit.create!(ref: 'v3', quantity1_1: 1, destination: Destination.create!(name: "l3", street: "Rue de Nuits", postalcode: "33000", city: "Bordeaux", lat: 44.84272, lng: -0.55013, customer: customer))
...
Visit.create!(ref: 'v4-1', quantity1_1: 0.5, destination: destination_4, tags: [frigo])
Visit.create!(ref: 'v4-2', quantity1_1: 0.5, destination: destination_4)
