class ChangeTimeToIntegerToVehicleUsages < ActiveRecord::Migration
  def up
    ...
    VehicleUsageSet.find_in_batches do |vehicle_usages|
      vehicle_usages.each do |vehicle_usage|
        ...
        vehicle_usage.rest_duration_temp = vehicle_usage.time.seconds_since_midnight.to_i if vehicle_usage.rest_duration
