...
class Visit < ActiveRecord::Base
  ...
  validates_time :close1, presence: false, allow_nil: true, if: :open1
  validates_time :close1, presence: false, on_or_after: :open1, :if => lambda { open1 && close1 }
  validates :close1, presence: true, if: :open2
  validates_time :open2, on_or_after: :close1, if: :open2
  validates_time :close2, presence: false, allow_nil: true, if: :open2
  validates_time :close2, presence: false, on_or_after: :open2, :if => lambda { open2 && close2 }
