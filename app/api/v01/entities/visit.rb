...
class V01::Entities::Visit < Grape::Entity
  ...
  expose(:open, documentation: { type: DateTime, desc: 'Deprecated, use open1 instead.' }) { |m| m.open1_absolute_time }
  expose(:close, documentation: { type: DateTime, desc: 'Deprecated, use close2 instead.' }) { |m| m.close1_absolute_time }
  expose(:open1, documentation: { type: DateTime }) { |m| m.open1_absolute_time }
  expose(:close1, documentation: { type: DateTime }) { |m| m.close1_absolute_time }
  expose(:open2, documentation: { type: DateTime }) { |m| m.open2_absolute_time }
