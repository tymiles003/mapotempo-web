...
class CustomersController < ApplicationController
  ...
  def customer_params
    ...
    if current_user.admin?
      params[:customer][:end_subscription] = Date.strptime(params[:customer][:end_subscription], I18n.t('time.formats.datepicker')).strftime(I18n.t('time.formats.activerecord_default')) if params[:customer] && params[:customer][:end_subscription]
