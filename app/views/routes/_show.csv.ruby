if route.vehicle_usage && @export_stores
  csv << [
    ...
    route.vehicle_usage.store_start.street,
    nil,
    route.vehicle_usage.store_start.postalcode,
    route.vehicle_usage.store_start.city,
    route.vehicle_usage.store_start.country,
...
if route.vehicle_usage && @export_stores
  csv << [
    ...
    route.vehicle_usage.store_stop.street,
    nil,
    route.vehicle_usage.store_stop.postalcode,
    route.vehicle_usage.store_stop.city,
    route.vehicle_usage.store_stop.country,
