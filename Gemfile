...
gem 'grape', github: 'Mapotempo/grape', branch: 'disable-deprecation-warnings' # FIXME wait for https://github.com/ruby-grape/grape-swagger/issues/364 and https://github.com/ruby-grape/grape-swagger/pull/375
gem 'grape-entity'
gem 'grape-swagger'
gem 'rack-cors'
gem 'swagger-docs'
