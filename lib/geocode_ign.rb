...
<XLS
  ...
  def self.complete(street, postalcode, city, country, lat = nil, lng = nil)
...
#        name: "#{street}, #{postalcode} #{city}",
  ...
  def self.code(street, postalcode, city, country, lat = nil, lng = nil)
...
<XLS
  ...
  def self.code_free(q, country, limit = 10, lat = nil, lng = nil)
    key = q
